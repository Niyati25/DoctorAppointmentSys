...
urlpatterns = [
    ...
    #This is User Panel
    path('usersignup/', userviews.USERSIGNUP, name='user_signup'),
    path('User/UserHome', userviews.USERHOME, name='userhome'),
    ...
    path('User/CancelAppointment', userviews.User_Cancel_Appointment, name='user_cancel_appointment'),
